...
bool SignalHandler::is_running() { return g_running.load(); }

bool SignalHandler::is_force_exit() { return g_force_exit.load(); }

void SignalHandler::trigger_shutdown() { g_running.store(false); }
